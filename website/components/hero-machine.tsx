...
export function HeroMachine() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      current = current >= FINAL_STEP ? 0 : current + 1;
  ...
  return (
    <div>
      ...
      <motion.div
        ...
        animate={{
          boxShadow: promoted
            ? "0 0 0 1px oklch(0.696 0.17 162.48 / 0.28), 0 0 44px oklch(0.696 0.17 162.48 / 0.1)"
            : "0 0 0 1px oklch(0.696 0.17 162.48 / 0), 0 0 44px oklch(0.696 0.17 162.48 / 0)"
        }}
        ...
        <div className="flex items-center justify-between gap-4 border-b border-border px-4 py-2.5 font-mono text-[11px] sm:text-xs">
          <span className="flex items-center gap-2 text-muted-foreground">
            <motion.span
              ...
              initial={false}
              animate={reduceMotion || !inView ? { opacity: 1 } : { opacity: [1, 0.3, 1] }}
              transition={
                reduceMotion || !inView ? { duration: 0 } : { duration: 2.4, repeat: Infinity }
              }
            />
        ...
        <div ref={contentRef} className="relative flex flex-col gap-5 p-4 pl-8 sm:p-5 sm:pl-9">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <motion.div
                ref={factRef}
                className="rounded-lg border border-primary/35 bg-background-raised px-3.5 py-3 font-mono text-[11px] leading-5 sm:text-xs"
                initial={false}
