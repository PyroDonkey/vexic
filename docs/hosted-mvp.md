...
- repo-local SQLite control-plane tenant catalog and in-memory API-key adapter;
...
- no durable hosted key/job store or production control-plane catalog,
  audit, or usage store;
