...
def server_instructions(enable_expand_history: bool = False) -> str:
    ...
    return (
        ...
        "priming:'). Facts already visible there need no re-search. This "
        "never weakens the search-first rule above: the snapshot is a "
        "sample, not the whole memory — before telling the user something "
