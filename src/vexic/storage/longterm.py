...
def record_long_term_retrieval(
    ...
    *,
    ...
    the same transaction (ADR-0008) so counters and events cannot disagree.
...
def record_fact_use_verdict(
    ...
    *,
    ...
    """Land a use-judge verdict (ADR-0008): mark this turn's retrieval events
...
def record_long_term_use(db_path: str, fact_ids: list[int]) -> None:
    ...
    transaction (ADR-0008). This primitive remains for callers that have fact
