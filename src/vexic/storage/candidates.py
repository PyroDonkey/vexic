...
# Tier 2 candidate-fallback retrieval (ADR-0010, COA-95): the eligibility
...
@dataclass(frozen=True)
class CandidateNote:
    # A Tier 2 candidate surfaced by candidate-fallback retrieval (ADR-0010),
...
def record_candidate_retrieval(
    ...
    *,
    ...
    retrieved_count in the same transaction (ADR-0010), mirroring
